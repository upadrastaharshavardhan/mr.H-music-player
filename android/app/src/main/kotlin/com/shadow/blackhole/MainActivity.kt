...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.shadow.mr.H/sharedTextChannel")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.shadow.mr.H/registerMedia")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.shadow.mr.H/intentChannel")
                .setMethodCallHandler { call: MethodCall, result: MethodChannel.Result ->
